...
# # 单进口道均衡
# inflow_light_1b = np.array([720, 1440, 2160, 2880, 3600, 4320])
# outflow_light_1b = np.array([749, 1189, 1440, 1560, 1494, 1541])
# avg_delay_light_1b = np.array([21.20, 52.33, 82.14, 86.8, 87.3, 86.45])

# inflow_xu_1b = np.array([720, 1440, 2160, 2880, 3600, 4320])
# outflow_xu_1b = np.array([532, 1423, 1921, 2053, 2061, 1962])
# avg_delay_xu_1b = np.array([3.93, 5.44, 15.04, 27.72, 29.26, 32])
# max_delay_xu_1b = np.array([12.28, 14.09, 53.21, 56.32, 60.28, 56.72])

# inflow_dres_1b = np.array([720, 1440, 2160, 2880, 3600, 4320])
# outflow_dres_1b = np.array([715, 1380, 2234, 2691, 3028, 3309])
# avg_delay_dres_1b = np.array([1.95, 2.97, 4.92, 10.47, 26.9, 29.39])
# max_delay_dres_1b = np.array([7.01, 13.62, 21.84, 51.5, 77.6, 94.56])


# # # 单进口道仅直行
# inflow_light_1ot = np.array([720, 1440, 2160, 2880, 3600])
# outflow_light_1ot = np.array([687, 1426, 2076, 2570, 2845])
# avg_delay_light_1ot = np.array([7.42, 10.7, 14.67, 27.9, 34.71])

# inflow_xu_1ot = np.array([720, 1440, 2160, 2880, 3600])
# outflow_xu_1ot = np.array([693, 1346, 1933, 2000, 2156])
# avg_delay_xu_1ot = np.array([3.35, 5.36, 7.32, 40.57, 54.33])

# inflow_dres_1ot = np.array([720, 1440, 2160, 2880, 3600])
# outflow_dres_1ot = np.array([792, 1608, 2090, 2829, 3353])
# avg_delay_dres_1ot = np.array([1.77, 2.44, 2.82, 4.39, 13.79])
